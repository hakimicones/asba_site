<div class="container"  dir="{dir}"> 
	<div class="cadre_cont ">
		...
		<div class="row">
			...
			<div id="simulation" class="col-md-7">
			...
			<div class="col-md-4">
				...
				<div style="display:block; width:100%;">
					<a class="btn btn-primary" href="{liens}">{liste} {des} {motos}</a>
				</div>
		...
		<div class="msg"> {message7}</div>

	</div>
</div>
<script src="composant/motos/assets/simul.js" type="text/javascript"></script>
<script>
function num(e) {
...
var tsu  = false ;
   ...
   // html +=affRubTexte('salaireCumule','{salaire Cumule}','{lg}','readonly="true"','',' hasValue');  
	...
	html +=affRubHidden('tauxMaxFin' , '100','readonly="true"' );
...
*/
	html +=affRubSelectAn( "sliderNb",'{Nombre d echeances}',36,'{lg}','id="nbEcheance" name="nbEcheance"', 36  );
