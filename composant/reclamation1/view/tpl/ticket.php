...
<div id ="ticket" class="container">
  ...
  <div class="row display display_ar " style="margin:0px; ">
        <div class="  card  bodyticket" style="margin : 20px 0px 20px 10px ;width: 30% ; padding: 15px">
            {departement} : {departementval}<br>
    {typedeticket} : {typeval}<br>
      {chiox} : {chioxval}<br>
       {etatticket} : {etatticketval}<br>
</div>
  <div class="  card  bodyticket" style="margin : 20px 10px 20px 0px; width: 68% ; padding: 15px"> {ticketbody}</div>
  ...
  <div class="  card  bodyticket" style="margin : 20px 0px 20px 10px; width: 68% ; padding: 15px"> {ticketbody}</div>
     <div class="  card  bodyticket" style="margin : 20px 10px 20px 0px ;width: 30% ; padding: 15px">
            {departement} : {departementval}<br>
    {typedeticket} : {typeval}<br>
      {chiox} : {chioxval}<br>
       {etatticket} : {etatticketval}<br>
