...
<div class="row">
  ...
  <a href="javascript:" class="btn btn-primary"  id="login" onclick="inscriptionlogin()" > 
    <span id ="textbtn">{inscription1}</span>
</a>
...
if (login==1) {
      $("#form").attr( "class", "col-12 visible" );
      $("#form2").attr( "class", "col-12 textbtn" );
      $("#form2").attr( "class", "col-12 invisible2" );
...
$('#textbtn').text("{login}"); 
	     ...
	     login=1; 
    	$("#form2").attr( "class", "col-12 visible" );
    	$("#form").attr( "class", "col-12 invisible2" );
    	$('#textbtn').text("{inscription1}"); 
