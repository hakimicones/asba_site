<div class="container"  dir="{dir}"> 
	...
	<h2>{auto}</h2>
		<div id="simulation" class="col-md-8">
		...
		<a class="btn btn-primary" href="{liens}">{liste} {des} {vehicules}</a>
		</div>
		<div class="msg"> {message7}</div>
		</div>
	</div>
</div>
<script src="composant/vehicules/assets/simul.js" type="text/javascript"></script>
<script>
function num(e) {
