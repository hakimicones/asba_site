...
/****************************************/
	...
	function affSimul1() {
	var html = ''; 
    var options = new Array(  new taux('{financement vehicule}',"10.5"  ) , new taux('{financement equipement}',"11" ));
  
	
	html +=affRubTexte('montantBien','{prix auto}','{lg}','onblur="num(this)"');
   ...
   // html +=affRubTexte('salaireCumule','{salaire Cumule}','{lg}','readonly="true"','',' hasValue');  
	...
	html +=affRubHidden('capaciteCautionConsomm' , '0','readonly="true"' );
    	...
    	html +=affRubTexte('capaciteNette','{capacite d endettement}','{lg}','readonly="true"' ,'',' no-data '); 
...
*/
	html +=affRubSelectAn( "sliderNb",'{Nombre d echeances}',60,'{lg}','id="nbEcheance" name="nbEcheance"' );
