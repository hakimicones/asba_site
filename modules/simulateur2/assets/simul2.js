        ...
        function separateurMilliers(val) {
        ...
        function updateCalc(apportIschanged,tva,t){                   
            ...
            var capaciteNette = parseFloat($("#capaciteNette").val().split(" ").join(""));
            montantBien = parseFloat($("#montantBien").val().split(" ").join(""));

            var str =  $("select[name=tauxCharge]").find(":selected").text();
            
            var stva  = $("#sanstva").val()
            if(stva)    tva = 0;
			...
			//	alert($("#salaireCumule").val());
				...
				$("#capaciteBrute").val(parseFloat(parseFloat(
				 $("#salaireCumule").val().split(" ").join("")) * parseFloat($("#tauxCapacite").val().split(" ").join("") / 100)).toFixed(2));
            ...
            if (!isNaN(parseFloat($("#capaciteConsomm").val().split(" ").join(""))) && !isNaN(parseFloat($("#capaciteCautionConsomm").val().split(" ").join(""))) && !isNaN(parseFloat($("#capaciteBrute").val().split(" ").join("")))){
                $("#capaciteNette").val(parseFloat(parseFloat($("#capaciteBrute").val().split(" ").join("")) -(parseFloat($("#capaciteConsomm").val().split(" ").join("")) + parseFloat($("#capaciteCautionConsomm").val().split(" ").join("")))).toFixed(2));
...
function affRubTexte(nom,lib,lg,tag='',css='') {
...
function affSlider(nom,lib,lg,css='',tag='',min=0,max=12) {
...
function affRubSelect(nom,lib,option,lg,tag) {
	var pos = ''
