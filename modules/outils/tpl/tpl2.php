<section id="tools">
	  <div class="container">
		...
		<a class="btn  " href="{lg}/vehicules/simulation-{pg}-0.html"> <img src="images/autre-sim-{lg}.png" alt="{autresim}"  /> </a>
...
function num(e) {
 		...
 		console.log("Valeur de a"+e.name+" : "+ b) ;
...
/****************************************/
	...
	html +=affRubTag('{marques}','{marque}','{lg}','id="marques-div"',' hasValue ');
...
*/
	html +=affRubSelectAn( "sliderNb",'{Nombre d echeances}',60,'{lg}','id="nbEcheance" name="nbEcheance"', 60  );
   ...
   html +=affRubHidden('salaireCumule','0','readonly="true"' );
	...
	html +=affRubSelectAn( "sliderNb",'{Nombre d echeances}',300,'{lg}','id="nbEcheance" name="nbEcheance"' );
