<section id="tools">
   ...
   html +='{message7}</div>';
	...
	html += affRubTexte('montantBien','{prix bien}','{lg}','' ,''); 
     ...
     var options = new Array( new taux('{financement dar al salam epargnant}',"7" ),new taux('{financement dar al salam epargnant dom }',"7.25"  ) ,new taux('{financement dar al salam non epargnant}',"7.75"  ) );
	...
	html += affRubTexte('salaireCoEmp','{salaire co-emprunteur}','{lg}','' ,''); 
  	...
  	html += affRubTexte('','{salaire Cumule}','{lg}','readonly="true"' ,' hasValue hasSep'); 
	...
	html += affRubTexte('{capacite d endettement}','{capaciteNette}','{lg}','readonly="true"' ,' hasValue hasSep');    
