...
/* methods */
    // CONNECTION
        public function connect() {
            ...
            try {
                ...
                $this->connection = new PDO($connString, $this->login, $this->password,array (PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES \'UTF8\''));
    ...
    // SELECT
        private function buildSelectQuery() {
            ...
            $query = $select.$from.$join.$where.$groupby.$orderby;
            $this->q = $query; 
            return $query;
        }
