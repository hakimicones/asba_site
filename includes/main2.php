...
class main {
	...
	public function getPages(  ) {
		...
		//  
			...
			//echo $this->param->volet2;
			if ($this->param->volet2) { 	
			
			$lh_pop = explode(";",	$this->param->style ) ;
				
				$this->script  .=  (!empty($this->ispage )) ?  "
				...
				$('#pop-home ').css('background',' url(".$this->param->style2.")').css('background-size','cover').css('background-color','#fff'); 
	...
	public function setScript() {  
		...
		return  '<script type="text/javascript">'.$this->script.'// rem </script> '   ;}
